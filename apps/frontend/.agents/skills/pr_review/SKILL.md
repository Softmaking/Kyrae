---
name: PR Review
description: Use when the user asks to "review PR", "review pull request", "check code changes", "review changes", "code review", or "analyze commits". Covers PR quality assessment, code consistency, performance impact, security concerns, test coverage review, and commit message evaluation.
---
