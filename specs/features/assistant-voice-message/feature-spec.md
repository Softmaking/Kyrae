...
HU-004: As a user, I want to speak to the assistant from the web so the system converts my voice into text and sends that transcription to OpenClaw as a normal assistant message.

## Goal

Add web voice input without breaking the existing assistant text flow:
